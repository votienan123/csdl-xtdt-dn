...
public class VaiTro extends Model<VaiTro> {
	...
	public static final String CHUDAUTU = "chudautu";
	public static final String CHUYENVIEN = "chuyenvien";
	public static final String QUANTRIVIEN = "quantrivien";
	
	public static final String[] VAITRO_DEFAULTS = { CHUDAUTU, CHUYENVIEN,QUANTRIVIEN};
	...
	public Set<String> getQuyenAllMacDinhs() {
		...
		quyens1.add(core().HOSOCONGTRINHTHEM);
		quyens1.add(core().HOSOCONGTRINHLIST);
		quyens1.add(core().HOSOCONGTRINHSUA);
		quyens1.add(core().HOSOCONGTRINHXOA);
		quyens1.add(core().HOSOCONGTRINHXEM);
		
		quyens1.add(core().KEHOACHNHUCAUVONTHEM);
		quyens1.add(core().KEHOACHNHUCAUVONLIST);
		quyens1.add(core().KEHOACHNHUCAUVONSUA);
		quyens1.add(core().KEHOACHNHUCAUVONXOA);
		quyens1.add(core().KEHOACHNHUCAUVONXEM);
		
		quyens1.add(core().BAOCAOKEHOACHVONTHEM);
		quyens1.add(core().BAOCAOKEHOACHVONLIST);
		quyens1.add(core().BAOCAOKEHOACHVONSUA);
		quyens1.add(core().BAOCAOKEHOACHVONXOA);
		quyens1.add(core().BAOCAOKEHOACHVONXEM);
	...
	public Set<String> getQuyenMacDinhs(String alias1) {
		...
		if (!alias1.isEmpty()) {
			if (CHUYENVIEN.equals(alias1)) {
				...
				quyens1.add(core().BAOCAOKEHOACHVONXOA);
				quyens1.add(core().BAOCAOKEHOACHVONXEM);
			} else if (CHUDAUTU.equals(alias1)) {
				quyens1.add(core().HOSOCONGTRINHTHEM);
				quyens1.add(core().HOSOCONGTRINHLIST);
				quyens1.add(core().HOSOCONGTRINHSUA);
				quyens1.add(core().HOSOCONGTRINHXOA);
				...
				quyens1.add(core().KEHOACHNHUCAUVONXOA);
				quyens1.add(core().KEHOACHNHUCAUVONXEM);
			} else if (QUANTRIVIEN.equals(alias1)) {
	...
	@Override
	public void doDelete(boolean trangThaiOnly) {
